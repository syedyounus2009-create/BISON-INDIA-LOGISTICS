// This file redirects to bisonClient.js for backward compatibility
import bisonClient, { bisonAPI } from './bisonClient';

export const bisonAPI = bisonAPI;
export const baysonClient = bisonClient;
...
// IMPORTANT: Also export as bisonAPI for backward compatibility
export const bisonAPI = bisonAPI;
